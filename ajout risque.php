...
if( isset($_POST["se_connecter"]) )
{
	...
	$StringErreur = "";
		if( $erreur == false ){
	 	...
	 	$insertion = $cnx->prepare("INSERT INTO risque(code_projet,détails,poids_de_risque) VALUES(?,?,?)");
		$insertion->execute(array($_POST["risq"],$_POST["risque"],$_POST["poids"]));
		if( $insertion->rowCount() > 0 )
		{
			$erreur = true;
			$StringErreur = 'risque  ajout\351 avec succ\351s !'; 
        ...
        <div id="left_menu">
            ...
            <li><a href="ajout livrable.php">Gestion de livrables</a></li>
             ...
             <li><a href="ajout risque.php">Gestion de risques</a></li>
			 									<li><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ajouter risque</a></li>
             <li><a href="consulter risque.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Consulter risque</a></li>
...
<label>Risque</label><select id="user" name="risq">
...
<label>D&eacute;tails du risque</label><input type="text" id="cin" name="risque"/><br>

<label>Poids du risque</label><select id="civilite" name="poids">
<option value="0">Veuillez choisir un poids</option>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Ajouter risque" id="se_connecter" name="se_connecter" /><br/>
</form>
