...
<div class="art-nav-inner">
	<ul class="art-hmenu">
			...
			<li>
			<a href="ajout uti.php" class="active"><span class="l"></span><span class="r"></span><span class="t">Gestion des utilisateurs</span></a>
		</li>	
		...
		<li>
			<a href="./ajout famille.php"><span class="l"></span><span class="r"></span><span class="t">gestion de projets</span></a>
		</li>
        <li>
      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
            <ul>
             ...
             <li><a href="activer.php">Activer un compte</a></li>
            </ul>
        </div> </div>
...
<label>Nom utilisateur</label><select id="user" name="login">
...
while($data = $requete->fetch() )
	echo '<option value='.$data["login"].'>'.$data["login"].' : '.$data["user"].'</option>';
?>
</select><br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   { require_once("includes/cnx.php");
	...
	while($data = $requete->fetch() )
	{
		$out .= "Login :<span class='info'>".$data["login"]."</span><br/>"
		         ."mot de passe :<span class='info'>".$data["password"]."</span><br/>"
				...
				."T&eacute;l&eacute;phone :<span class='info'>".$data["num_tel"]."</span><br/>"
		...
		switch($data["profil"])
		{
			case '1':
				...
				break;
			case '2':
				$out .= "Profil <span class='info'>Chef de projets<br/>";
				break;
			case '3':
				$out .= "Profil <span class='info'>Collaborateur</span><br/>";
				break;			
		}
		...
		{
			case '1':
				$out .= "Statut compte :<span class='info'>Activ&eacute;</span><br/>";
				break;
			case '2':
				$out .= "Statut compte : <span id=\"derniere\" class='info'>D&eacute;sactiv&eacute;</span><br/><br/><br/><br/>";
				break;			
		}
