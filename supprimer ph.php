...
if (isset ($_POST["phase"]))
  { require_once("includes/cnx.php");
	...
	$requete->execute(array($_SESSION["a"]));
		...
		{
			$erreur = true;
			$StringErreur = "La phase  a \351t\351 supprim\351 avec succ\351s!";
...
<label>Nom phase</label><select id="user" name="phase">
<option value="Vide">Veuillez selectionner une phase</option>
<?php
require_once("includes/cnx.php");
$requete = $cnx->query("SELECT code_phase ID,nom_ph FROM phase");
