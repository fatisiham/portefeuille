...
<div class="art-block">
    ...
    <div class="art-block-body">
      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
            <ul>
						 <li><a href="ajout_proj.php">ajouter livrable</a></li>
			 <li><a href="desa.php">consulter livrable</a></li>
...
<label>Nom livrable</label><input type="text" id="email" name="email"/><br>
