...
$_SESSION["a"]=$_POST["famille"];
		header("location:ajout projet.php");
		exit();
}
      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
			...
			<li><a href="supprimer proj.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Supprimer projet</a></li>
             <li><a href="modifier.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Modifier projet</a></li>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Suivant" id="se_connecter" name="se_connecter" /><br/>
</form>
