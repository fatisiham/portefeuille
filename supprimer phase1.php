...
if (isset ($_POST["phase"]))
  { require_once("includes/cnx.php");
	$requete = $cnx->prepare("DELETE FROM phase WHERE code_projet LIKE ?");
	$requete->execute(array($_SESSION["a"]));
			if($requete->rowCount() > 0)
		{
			$erreur = true;
			$StringErreur = "La phase a \351t\351 supprim\351e avec succ\351s!";
...
<label>Nom phase</label><select id="user" name="proj">
<option value="Vide">Veuillez selectionner une phase</option>
<?php
require_once("includes/cnx.php");
$requete = $cnx->query("SELECT code_phase ID,nom_ph FROM phase where code_projet like ?");
$requete->execute(array($_SESSION["a"]));
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" value="Supprimer" name="voir"/> <br/>
</form> <br/> <br/>  <br/>
</p>
