...
<div class="art-block">
    ...
    <div class="art-block-body">
      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
            <ul>
             <li><a href="consultation.php">gestion de projets</a></li>
             <li><a href="modif.php">gestion de phases</a></li>
             <li><a href="desa.php">gestion de livrables</a></li>
			 <li><a href="ajout_proj.php">ajouter risque</a></li>
...
<label>D&eacute;tails</label><input type="text" id="email" name="email"/><br>
<label>Poids du risque</label>
<select id="user" name="login">
<option value="Vide">Veuillez selectionner un poids</option>
