      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
			...
			<li><a href="ajout phase.php">Gestion de phases</a></li>
						<li><a href="ajout phase.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ajouter phase</a></li>
...
<label>Nom projet</label><select id="user" name="proj">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" value="Consulter" name="voir"/> <br/>
</form> <br/> <br/>  <br/>
<p>
<?php
if (isset ($_POST["voir"]))
...
if (isset ($_POST["proj"]))
   { require_once("includes/cnx.php");
	$requete = $cnx->prepare("SELECT * FROM projet WHERE code_projet LIKE ?");
	$requete->execute(array($_POST["proj"]));
	$out = '<style type="text/css">
			...
			$out .="liste de phases appartenants a ce projet : </br></br>"; 
while($data = $requete->fetch() )
	   { 	$rech = $cnx->prepare("SELECT nom_ph ,num_phase , date_debut_p , date_debut_r, date_fin_p, date_fin_r, date_creation FROM phase WHERE code_projet LIKE ?");
            $rech->execute(array($data["code_projet"]));
	        while ($chef=$rech->fetch())
			{$out .= "Nom de phase  :<span class='info'>".$chef["nom_ph"]."</span><br/>";
	         $out .= "Num phase:<span class='info'>".$chef["num_phase"]."</span><br/>";
	         $out .= "date de debut planifi&eacute;:<span class='info'>".$chef["date_debut_p"]."</span><br/>";
	         $out .= "date de fin planifi&eacute;:<span class='info'>".$chef["date_fin_p"]."</span><br/>";
	         $out .= "date de debut r&eacute;elle:<span class='info'>".$chef["date_debut_r"]."</span><br/>";
	         $out .= "date de fin r&eacute;elle:<span class='info'>".$chef["date_fin_r"]."</span><br/>";
	         $out .= "date de cr&eacute;ation;:<span class='info'>".$chef["date_creation"]."</span><br/><br/><br/>";}
