...
//NOM
	...
	{
		$erreur = true;
		$StringErreur = "Veuillez remplir le champs : nom famille !<br/>";
	}
	if( $erreur == false )
	{
		require_once("includes/cnx.php");
		$requete = $cnx->prepare("SELECT nom famille FROM famille WHERE nom famille LIKE ?");
		$requete->execute(array($_POST["nom"]));
		if($requete->rowCount() > 0)
		{
			$erreur = true;
			$StringErreur = "Nom de famille existe déja !";
			goto SortieSi;
		}
	 	$insertion = $cnx->prepare("INSERT INTO famille(nom famille, date_creation) VALUES(?,NOW())");
		$insertion->execute(array($_POST["nom"]));
		if( $insertion->rowCount() > 0 )
		{
			$erreur = true;
			$StringErreur = 'famille ajout&eacute;e avec succés !'; 
      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
            <ul>
             ...
             <li><a href="modif.php">Consulter projets</a></li>
             <li><a href="desa.php">Supprimer projet</a></li>
			 
			 
			 
			<li><a href="desa.php">ajouter phase</a></li>
			<li><a href="desa.php">Consulter phases</a></li>
			<li><a href="desa.php">Supprimer phase</a></li>
			
			
            <li><a href="desa.php">Ajouter livrable</a></li>
			<li><a href="desa.php">Supprimer livrable</a></li>
            <li><a href="desa.php">onsulter livrables</a></li>
			
             <li><a href="desa.php">Ajouter risque</a></li>
             <li><a href="desa.php">Supprimer risque </a></li>
             <li><a href="desa.php">Consulter risques </a></li>
...
<input type="submit" value="Cr&eacute;er famille" id="se_connecter" name="Ajouter" /><br/>
</form>
