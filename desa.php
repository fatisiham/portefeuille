      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
            ...
            <li><a href="aj uti.php">Ajouter intervenant</a></li>
             ...
             <li><a href="#">D&eacute;sactiver compte</a></li>
...
<label>Liste des comptes activ&eacute;s : </label><select id="user" name="id">
<option value="Vide">Veuillez choisir un utilisateur</option>
<?php
require_once("includes/cnx.php");
$requete = $cnx->query("SELECT code_intervenant ID,login,CONCAT(nom,' ',prenom) AS user FROM intervenant where statut=1");
while($data = $requete->fetch() )
	echo '<option value='.$data["ID"].'>'.$data["login"].' : '.$data["user"].'</option>';
?>
</select><br/>
<div id="buttons">
<input type="submit" value="D&eacute;sactiver" id="valider" name="valider" /> <br/>
</div>
</form></p>
                </div>
                <div class="cleared"></div>
