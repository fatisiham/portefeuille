...
<div class="art-nav-inner">
	<ul class="art-hmenu">
			...
			<a href="ajout uti.php"><span class="l"></span><span class="r"></span><span class="t">Gestion des utilisateurs</span></a>
					...
					<li>
			<a href=".#" class="active"><span class="l"></span><span class="r"></span><span class="t">Gestion de profils</span></a>
		</li>	
...
<div class="art-block">
    ...
    <div class="art-block-body">
      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
            <ul>
             <li><a href="#">Consulter role</a></li>
             <li><a href="changer-profil.php">Changer role</a></li>
            </ul>
        </div> </div>
...
if (isset ($_POST["login"]))
   { require_once("includes/cnx.php");
	$requete = $cnx->prepare("SELECT * FROM intervenant WHERE login LIKE ? ");
...
{switch($data["profil"])
		{
			case '1':
				$out .= $_POST["login"]."&nbsp;:&nbsp;Profil :<span class='info'>Administrateur </span></span><br/>";
				break;
			case '2':
				$out .= $_POST["login"]."&nbsp;:&nbsp;Profil :<span class='info'>Chef de projets<br/>";
				break;
			case '3':
				$out .= $_POST["login"]."&nbsp;:&nbsp;Profil :<span class='info'>Collaborateur</span><br/>";
				break;			
		}
