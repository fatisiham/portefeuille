...
<div class="art-block">
    ...
    <div class="art-block-body">
      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
            <ul>
             <li><a href="ajout_proj.php">Ajouter projet</a></li>
             <li><a href="consultation.php">Modifier param&eacute;tres</a></li>
            ...
            <li><a href="desa.php">Gestion de livrable</a></li>
...
<label>Famille</label><input type="text" id="nom" name="nom"/><br>
...
<label>date de debut planifi&eacute;</label><input type="text" id="cin" name="cin"/><br>
<label>date de fin planifi&eacute;</label><input type="text" id="date_p" name="date_p"/>
<br/>
