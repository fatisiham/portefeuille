...
<div class="art-nav-inner">
	<ul class="art-hmenu">
			...
			<a href="./new-page-2.html"><span class="l"></span><span class="r"></span><span class="t">Acceuil</span></a>
				...
				<li>
			<a href="ajout uti"><span class="l"></span><span class="r"></span><span class="t">gestion des utilisateurs</span></a>
		</li>
    ...
    <div class="art-block-body">
      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
			...
			<li><a href="ajout famille.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ajouter famille</a></li>
             <li><a href="consulter famille.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Consulter famille</a></li>
...
if (isset ($_POST["famille"]))
   { require_once("includes/cnx.php");
	$requete = $cnx->prepare("SELECT * FROM projet WHERE code_famille LIKE ?");
	...
	$out = '<style type="text/css">
			...
			$out .="liste des projet appartenants a cette famille : </br></br>"; 
	while($data = $requete->fetch() )
	   { 	$rech = $cnx->prepare("SELECT nom , prenom FROM intervenant WHERE code_intervenant LIKE ?");
