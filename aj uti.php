...
else
{
	...
	$lastlog = $cnx->exec("UPDATE intervenant SET date_last_log=NOW() WHERE login LIKE '".$_SESSION["user"]."'");
...
if( isset($_POST["se_connecter"]) )
{
	...
	{
		$erreur = true;
		$StringErreur = "Le login est invalide /n!";
	}
	//PASSWORD
	...
	if( $erreur == false )
	{
		...
		{
			$erreur = true;
			$StringErreur = "adresse m@il/login existe d\351ja !";
			goto SortieSi;
		}
		...
		{
			$erreur = true;
			$StringErreur = 'Utilisateur ajout\351 avec succ\351s !'; 
...
<div class="art-nav-inner">
	<ul class="art-hmenu">
			...
			<li>
			<a href="#" class="active"><span class="l"></span><span class="r"></span><span class="t">Gestion des utilisateurs</span></a>
		</li>	
