...
{if( isset($_POST["id"]) )
	{
	$requete_changement = $cnx->exec("UPDATE intervenant SET profil=".$_POST["NouveauRole"]." WHERE code_intervenant=".$_POST["id"]);

	if($requete_changement > 0)
	{$Erreur="true";
	 $out='Le changement a \351t\351 effectu\351 !';
	 }
	 else
	 {$Erreur="true";
	 $out='Aucun changement n\'a  \351t\351 \351ffectu\351!';}
...
<div class="art-nav-inner">
	<ul class="art-hmenu">
			<li>
			<a href="./aj phase.php"><span class="l"></span><span class="r"></span><span class="t">Accueil</span></a>
		</li>
			...
			<a href="aj uti.php"><span class="l"></span><span class="r"></span><span class="t">Gestion des utilisateurs</span></a>
					...
					<li>
			<a href="gp.php" class="active"><span class="l"></span><span class="r"></span><span class="t">Gestion de profils</span></a>
		</li>	
...
<div class="art-block">
    ...
    <div class="art-block-body">
      ...
      <div class="left_sidebar">
        ...
        <div id="left_menu">
            <ul>
             <li><a href="gp.php">Consulter role</a></li>
             <li><a href="#">Changer role</a></li>
            </ul>
        </div> </div>
...
<label>Nom utilisateur</label><select id="user" name="id">
...
<label>Nouveau profil</label><select id="new" name="NouveauRole">
...
<br/>
<input type="submit" id="valider" value="Changer" name="valider"/>
</form><br/><br/>
</div></p>
