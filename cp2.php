...
if( isset($_POST["se_connecter"]) )
{
	...
	{
		$erreur = true;
		$StringErreur .= "Le reference marché est invalide !<br/>";
	}
	...
	if( $erreur == false )
	{
		...
		$insertion->execute(array($_SESSION["b"],$_SESSION["a"],$_POST["ss_famille"],$_POST["nom"],$_POST["moe"],$_POST["mo"],'1',$_POST["date"],$_POST["date2"],$_POST["ref"]));
