...
<label>date de debut r&eacute;elle</label><input  name="date_d"  value="00-00-0000" /><br /><br>
<label>date de fin r&eacute;elle</label><input  name="date_f"  value="00-00-0000" /><br />

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" value="Modifier" name="voir"/> <br/>
</form> <br/> <br/>  <br/>
<p>
<?php
if (isset ($_POST["voir"]))
...
if (isset ($_POST["proj"]))
   { require_once("includes/cnx.php");
	...
	$requete_changement = $cnx->exec("UPDATE projet SET date_debut_r=".$_POST["date_d"].", date_fin_r= ".$_POST["date_f"]."WHERE code_projet=".$_POST["proj"]);
